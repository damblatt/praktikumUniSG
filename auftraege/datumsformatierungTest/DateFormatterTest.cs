namespace datumsformatierung.test
{
    ...
    public class DateFormatterTest
    {
        ...
        [TestMethod]
        public void dateFormatter_GetFormattedDate_CH_incorrect()
        {
            // Arrange
            var dateFormatter = new DateFormatter();
            var date = new Date(32, 02, 2003);
            ...
            // Assert
            Assert.AreEqual("invalid date", output);
        }
        ...
        [TestMethod]
        public void dateFormatter_GetFormattedDate_US_incorrect()
        {
            // Arrange
            var dateFormatter = new DateFormatter();
            var date = new Date(01, 13, 2003);
        ...
        [TestMethod]
        public void dateFormatter_GetFormattedDate_ISO_incorrect()
        {
            // Arrange
            var dateFormatter = new DateFormatter();
            var date = new Date(01, 02, -1);
